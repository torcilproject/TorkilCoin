...
This mechanism has been integrated into Bitcore-Node-TorkilCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TorkilCoin-Project/insight-api-torkilcoin#web-socket-api](https://github.com/TorkilCoin-Project/insight-api-torkilcoin#web-socket-api) 
* API: [https://github.com/TorkilCoin-Project/insight-api-torkilcoin#swifttx-transactions](https://github.com/TorkilCoin-Project/insight-api-torkilcoin#swifttx-transactions) 
...
By default, the TorkilCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TorkilCoin Core daemon:
