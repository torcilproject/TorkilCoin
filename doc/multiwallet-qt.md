...
In order to support loading of multiple wallets in torkilcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is torkilcoin.cpp.
...
Changes to torkilcoin.cpp
----------------------
torkilcoin.cpp is the entry point into torkilcoin-qt, and as such, will require some minor modifications to provide hooks for
