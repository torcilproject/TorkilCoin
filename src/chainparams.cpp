...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 39397;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // TorkilCoin starting difficulty is 1 / 2^12
        ...
        assert(hashGenesisBlock == uint256("233ddf491e84f3483427164e15c653dd1c02b5859ed4db78f4c32833ee440b52"));
        ...
        vSeeds.push_back(CDNSSeedData("89.223.95.45", "89.223.95.45"));           // Single node address
...
*/
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet torkilcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet torkilcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet torkilcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet torkilcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet torkilcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 39393;
        assert(hashGenesisBlock == uint256("8f2b1975f3f3823c28c48da5d7827144a42a785338ed3b492c038a41c8573b17"));
