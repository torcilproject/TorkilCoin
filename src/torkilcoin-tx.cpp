...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Torkilcoin Core torkilcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  torkilcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded torkilcoin transaction") + "\n" +
                               "  torkilcoin-tx [options] -create [commands]   " + _("Create hex-encoded torkilcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded torkilcoin transaction
