...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop TorkilCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "TorkilCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Torkilcoin features */
        {"torkilcoin", "masternode", &masternode, true, true, false},
        {"torkilcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"torkilcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"torkilcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"torkilcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"torkilcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"torkilcoin", "startmasternode", &startmasternode, true, true, false},
        {"torkilcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"torkilcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"torkilcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"torkilcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"torkilcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"torkilcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"torkilcoin", "mnbudget", &mnbudget, true, true, false},
        {"torkilcoin", "preparebudget", &preparebudget, true, true, false},
        {"torkilcoin", "submitbudget", &submitbudget, true, true, false},
        {"torkilcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"torkilcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"torkilcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"torkilcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"torkilcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"torkilcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"torkilcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"torkilcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"torkilcoin", "mnsync", &mnsync, true, true, false},
        {"torkilcoin", "spork", &spork, true, true, false},
        {"torkilcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"torkilcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use torkilcoind, or the -server option to torkilcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> torkilcoin-cli " + methodname + " " + args + "\n";
}
