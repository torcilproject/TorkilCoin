...
/** Utility functions used by the TorkilCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render TorkilCoin addresses in monospace font
...
// Parse "torkilcoin:" URI into recipient object, return true on successful parsing
