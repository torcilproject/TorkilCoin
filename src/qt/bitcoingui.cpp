                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TorkilCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TorkilCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and torkilcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TorkilCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about TorkilCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TorkilCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TorkilCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TorkilCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a TorkilCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TorkilCoin Core help message to get a list with possible TorkilCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TorkilCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TorkilCoin network", "", count));
}
...
{
    QString strTitle = tr("TorkilCoin Core"); // default title
