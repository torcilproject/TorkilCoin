...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TorkilCoin Core"),
     ...
     * override -datadir in the torkilcoin.conf file in the default data directory
     * (to be consistent with torkilcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
